...
function getSuggestionForModelBlockAttribute(block, lines) {
    ...
    // create deep copy
    const suggestions = (0, completionUtils_1.removeInvalidAttributeSuggestions)((0, klona_1.klona)(completionUtils_1.blockAttributes), block, lines);
...
function getSuggestionForNativeTypes(foundBlock, lines, wordsBeforePosition, document) {
    const activeFeatureFlag = (0, util_1.declaredNativeTypes)(document);
    if (
    ...
    const suggestions = (0, completionUtils_1.getNativeTypes)(document, prismaType);
    return {
        items: suggestions,
        isIncomplete: true,
    };
...
function getSuggestionForFieldAttribute(block, currentLine, lines, wordsBeforePosition, document) {
    ...
    if (wordsBeforePosition.length >= 2) {
        ...
        const nativeTypeSuggestions = (0, completionUtils_1.getNativeTypes)(document, prismaType);
        if (datasourceName) {
    ...
    const modelOrTypeOrEnum = (0, util_1.getModelOrTypeOrEnumBlock)(fieldType, lines);
    if ((modelOrTypeOrEnum === null || modelOrTypeOrEnum === void 0 ? void 0 : modelOrTypeOrEnum.type) === 'type') {
    ...
    const isAtIdAllowed = fieldType === 'Int' || fieldType === 'String' || (modelOrTypeOrEnum === null || modelOrTypeOrEnum === void 0 ? void 0 : modelOrTypeOrEnum.type) === 'enum';
    if (!isAtIdAllowed) {
        // id not allowed
    ...
    suggestions = (0, completionUtils_1.removeInvalidAttributeSuggestions)(suggestions, block, lines);
    return {
        items: suggestions,
        isIncomplete: false,
    };
...
function getSuggestionForDataSourceField(block, lines, position) {
    // create deep copy
    const suggestions = (0, klona_1.klona)(completionUtils_1.supportedDataSourceFields);
...
function getSuggestionForBlockTypes(lines) {
    // create deep copy
    const suggestions = (0, klona_1.klona)(completionUtils_1.allowedBlockTypes);
    ...
    switch (blockType) {
        case 'generator':
            ...
            // previewFeatures
                ...
                const generatorPreviewFeatures = (0, listAllAvailablePreviewFeatures_1.default)();
        ...
        case 'datasource':
            ...
            if (currentLine.startsWith('provider')) {
                ...
                if ((0, util_1.isInsideAttribute)(currentLineUntrimmed, position, '()')) {
                    ...
                    if (currentLine.includes('env')) {
                        return {
                            items: completionUtils_1.dataSourceUrlArguments.filter((a) => !a.label.includes('env')),
                            isIncomplete: true,
                        };
                    }
                    return {
                        items: completionUtils_1.dataSourceUrlArguments,
                        isIncomplete: true,
                    };
                }
            }
            ...
            else if ((previewFeatures === null || previewFeatures === void 0 ? void 0 : previewFeatures.includes('referentialintegrity')) &&
