 ...
 */
export declare function removeInvalidAttributeSuggestions(supportedAttributes: CompletionItem[], block: Block, lines: string[]): CompletionItem[];
/**
...
export declare function getNativeTypes(document: TextDocument, prismaType: string): CompletionItem[];
