...
`)}writeToFile(e,t){!this.options.write||this.options.checkFormatted||t.length===0||_.default.isNull(t)||_.default.isEmpty(t)||H.default.writeFile(e,t,n=>{n&&(g.default.stdout.write(`${$.default.red(n.message)}
...
`));return}_.default.each(this.diffs,e=>we(e))}}printErrors(){_.default.isEmpty(this.errors)||(g.default.stdout.write($.default.red.bold(`
Errors: 

`)),_.default.each(this.errors,e=>g.default.stdout.write(`${oe.default.format(e)}
