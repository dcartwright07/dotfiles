...
vim.api.nvim_set_hl(0, 'StatusLineNonText', { fg = colors.light_grey, bg = colors.bg })
vim.api.nvim_set_hl(0, 'StatusLine',
  { fg = vim.api.nvim_get_hl_by_name('StatusLine', true).foreground, bg = colors.bg })

vim.api.nvim_set_hl(0, 'TelescopePromptBorder', { fg = colors.darker_grey, bg = colors.darker_grey })
vim.api.nvim_set_hl(0, 'TelescopePromptNormal', { fg = colors.white, bg = colors.charcoal })
vim.api.nvim_set_hl(0, 'TelescopePromptTitle', { fg = colors.yellow, bg = colors.dark_grey })
vim.api.nvim_set_hl(0, 'TelescopePromptCounter', { fg = colors.light_grey, bg = colors.charcoal })
vim.api.nvim_set_hl(0, 'TelescopeResultsBorder', { fg = colors.darker_grey, bg = colors.darker_grey })
vim.api.nvim_set_hl(0, 'TelescopeResultsNormal', { fg = colors.white, bg = colors.darker_grey })
vim.api.nvim_set_hl(0, 'TelescopeResultsTitle', { fg = colors.darker_grey, bg = colors.darker_grey })
vim.api.nvim_set_hl(0, 'TelescopePreviewBorder', { fg = colors.darker_grey, bg = colors.darker_grey })
vim.api.nvim_set_hl(0, 'TelescopePreviewNormal', { bg = colors.charcoal })
