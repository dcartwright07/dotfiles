...
vim.api.nvim_set_hl(0, 'StatusLineNonText', { fg = colors.light_grey, bg = colors.charcoal })
vim.api.nvim_set_hl(0, 'StatusLine',
  { fg = vim.api.nvim_get_hl_by_name('StatusLine', true).foreground, bg = colors.charcoal })
